...
class Model_stat:
    def __init__(self, model, movement, toughness, save, wounds, leadership, object_control, weapons, inv_s, pic):
        self.model = model
...
class Weapons:
    def __init__(self, name, range, attack, weapon_skill, strength, armour_penetration, damage):
        self.name = name
        self.range = range
        self.attack = attack
        self.damage = damage
...
weapons = [
    ...
    Weapons("Bolt Pistol", 12, 1, 3, 4, 0, 1),
