...
def main():
  ...
  while restart == True:
      ...
      if SearchSelect_choice == "search":
          ...
          print("Now accept the popup icon that asks you to allow")
          time.sleep(5)
          url = "https://wahapedia.ru/wh40k10ed/the-rules/core-rules/#Weapon-Abilities"
          js_code = f"""
          <script>
...
imperium = {
    "Combat Patrol": [
        Model_stat("Infernus Squad", 1, 6, 2, 4, 3, 6, ["Bolt Pistol", "Pyreblaster", "SpaceMarine CC weapon"], "None"),
        Model_stat("Terminator Squad", 1, 5, 3, 5, 2, 6, ["Power Sword", "Storm bolter", "Chainfist"], "4+"),
        Model_stat("Captain in Terminator Armour", 1, 5, 6, 5, 2, 6, ["Storm bolter", "Combi-weapon", "Relic fist", "Relic weapon"], "4+"),
        Model_stat("Librarian in Terminator Armour", 1, 5, 5, 5, 2, 6, ["Combi-weapon", "Smite - witchfire", "Smite - focused witchfire",  "Storm bolter", "Force weapon"], "4+"),
    ],

    "Other": [
        Model_stat("Librarian", 1, 6, 4, 4, 3, 6, ["Bolt Pistol", "Smite - witchfire", "Smite - focused witchfire",  "Force weapon"], "None"),
        Model_stat("Captain", 1, 6, 5, 4, 3, 6, ["Bolt Pistol", "Heavy bolt pistol", "Master-crafted boltgun", "Neo-volkite pistol", "SpaceMarine CC weapon", "Master-crafted power weapon", "Power fist" ], "4+"),
        Model_stat("Infernus Squad", 1, 6, 2, 4, 3, 6, ["Bolt Pistol", "Pyreblaster", "SpaceMarine CC weapon"], "None"),
        Model_stat("Terminator Squad", 1, 5, 3, 5, 2, 6, ["Power Sword", "Storm bolter", "Chainfist", "Power Weapon", "Aussalt Cannon",], "4+"),
        Model_stat("Captain in Terminator Armour", 1, 5, 6, 5, 2, 6, ["Storm bolter", "Combi-weapon", "Relic fist", "Relic weapon"], "4+"),
        Model_stat("Librarian in Terminator Armour", 1, 5, 5, 5, 2, 6, ["Combi-weapon", "Smite - witchfire", "Smite - focused witchfire",  "Storm bolter", "Force weapon"], "4+"),
...
necron ={
    "Combat Patrol": [               # OC M  W  T  S  L  Weapon --> Inv S
        Model_stat( "Necron Warriors", 2, 5, 1, 4, 4, 7,  ["Gauss flayer", "Gauss reaper", "Necron CC weapon"], "None"),
        Model_stat( "Skorpekh Destroyers", 2, 8, 3, 6, 3, 7,  ["Skorpekh hyperphase weapons"], "None"),
        Model_stat( "Canoptek Scarab swarms", 0, 10, 4, 2, 6, 8,  ["Feeder mandibles"], "None"),
        Model_stat( "Canoptek Doomstalker", 4, 8, 12, 8, 3, 8,  ["Twin Gauss flayer", "Doomsday blaster", "Doomstalker limbs"], "4+"),
        Model_stat("Overlord", 1, 6, 6, 6, 3, 6, ["Staff of light(range)", "Tachyon arrow", "Staff of light(melee)", "Overlord's blade", "Voidscythe",], "4+")
    ],
    "Other": [               # OC M  W  T  S  L  Weapon --> Inv S
        ...
        Model_stat( "Canoptek Doomstalker", 4, 8, 12, 8, 3, 8,  ["Twin Gauss flayer", "Doomsday blaster", "Doomstalker limbs"], "4+"),
        Model_stat("Overlord", 1, 6, 6, 6, 3, 6, ["Staff of light(range)", "Tachyon arrow", "Staff of light(melee)", "Overlord's blade", "Voidscythe",], "4+"),
        Model_stat("Monolith", 8, 8, 22, 13, 2, 7, ["Death ray", "Gauss flux arc", "Particle whip", "Portal of Exile",], "None")
    ],

    "The Silent King": [
        Model_stat( "Szarekh", 6, 8, 16, 10, 2, 6,  ["Scepter of Eternal Glory", "Staff of Stars", "Weapons of the Final Triarch"], "4+"),
        Model_stat( "Triarchal Menhir", 1, 8, 5, 10, 2, 6,  ["Annhiliator beam", "Armoured bulk"], "4+"),
    ]                                 # OC M  W  T  S  L  Weapon --> Inv S
...
tyranids ={
    "Combat Patrol": [           # OC M  W  T  S  L  Weapon --> Inv S
        Model_stat( "Psychophage", 3, 8, 10, 9, 3, 8,  ["Psychoclastic torrent", "Talons and betentacled maw"], "None"),
        Model_stat( "Termagaunts", 2, 6, 1, 3, 5, 8,  ["Fleshborer", "Shardlauncher", "Spike rifle", "Strangleweb", "Termaguant devourer", "Termaguant spinefists", "Chitinous claws and teeth"], "None"),
    ],
